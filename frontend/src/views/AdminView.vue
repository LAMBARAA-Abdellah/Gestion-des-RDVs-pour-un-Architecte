<template>
    <main class="all">
                ...
                <div class="navbar">
                    <div class="container nav-container">
                        ...
                        <div class="menu-items">
                            ...
                            <li>
                                <router-link class="active" to="/client">Clients</router-link>
                            </li>
                            <li>
        ...
        <div class="adcontent">
            ...
            <div class="adrecherche">
                <form class="adexample">
                    <input type="text" placeholder="Search By Name" name="search2" />
                    <button href="submit">
            ...
            <div class="table">
                <table>
                    ...
                    <tbody>
                        <tr v-for="data in tableau" :key="data.id_r">
                            <td>{{ data.lname }} {{ data.fname }}</td>
                            <td>{{ data.tel }}</td>
                            <td>{{ data.profession }}</td>
                            <td>{{ data.date_r }}</td>
                            <td>{{ data.id_creneau }}</td>
                            <td>{{ data.sujet }}</td>
                        </tr>
                    </tbody>
                </table>
...
export default {
    ...
    mounted() {
        ...
        fetch("http://localhost/rdv/backend/admin/getAllRdv").then(res => res.json()).then(tableau => {
